    ...
    <Fragment>
      <Grid container alignItems="center" className={classes.header}>
        <Grid item className={classes.heroText}>
          <Typography variant="h4" gutterBottom style={{ fontWeight: "bold", color: "#444444", margin: "0" }}>
            Welcome Sid!
          </Typography>
          
          <Typography variant="subtitle1" gutterBottom style={{ color: "#666666" }}>
            Last activity: Logged in Yesterday
          </Typography>
